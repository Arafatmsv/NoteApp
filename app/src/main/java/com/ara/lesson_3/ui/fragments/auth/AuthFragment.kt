package com.ara.lesson_3.ui.fragments.auth
...
import com.ara.lesson_3.databinding.FragmentAuthBinding
...
class AuthFragment : Fragment() {
    ...
    private fun AuthFragment.firebaseAuthWithGoogle(idToken: String?) {
    ...
    private fun AuthFragment.updateUI(user: FirebaseUser?) {
        if (user != null) {
            PreferenceHelper.setAuthorized(true)
